          ...
          <div className="relative">
            ...
            <div className="absolute top-[30rem] left-1/2 -translate-x-1/2 text-center z-10">
              ...
              <div className="-mt-14 overflow-hidden relative z-50 w-screen left-1/2 -translate-x-1/2">
                <div className="absolute left-0 top-0 bottom-0 w-80 bg-gradient-to-r from-black via-black to-transparent z-20 pointer-events-none" />
                <div className="absolute right-0 top-0 bottom-0 w-80 bg-gradient-to-l from-black via-black to-transparent z-20 pointer-events-none" />
