          ...
          */}
          <div className="relative mx-auto h-[100svh] w-full translate-y-0 min-[900px]:h-full min-[900px]:w-auto min-[900px]:flex min-[900px]:flex-row-reverse min-[900px]:items-start min-[900px]:gap-8">
            <img
              ...
              className="block w-full h-full max-w-none object-cover object-center min-[900px]:object-contain min-[900px]:h-[85vh] min-[900px]:w-auto min-[900px]:mt-20 transition-transform"
              loading="eager"
              fetchPriority="high"
            />
      ...
      <section className="relative bg-background pt-8 pb-32 overflow-visible">
        <div className="flex flex-col items-center text-center px-4">
          <div className="relative">
            ...
            />
            <div className="absolute top-[30rem] left-1/2 -translate-x-1/2 text-center z-10">
              ...
              <div className="-mt-14 overflow-hidden relative z-50 w-screen left-1/2 -translate-x-1/2">
                <div className="absolute left-0 top-0 bottom-0 w-56 bg-gradient-to-r from-black via-black/95 to-transparent z-20 pointer-events-none" />
                <div className="absolute right-0 top-0 bottom-0 w-56 bg-gradient-to-l from-black via-black/95 to-transparent z-20 pointer-events-none" />
