    ...
    <div className="min-h-screen bg-black">
      ...
      <section className="relative min-h-screen bg-black overflow-hidden">
        ...
        <div className="absolute inset-0 w-full h-full flex flex-col items-center justify-start lg:justify-center -mt-[12%] lg:mt-0">
          ...
          <div className="lg:hidden flex flex-col items-center text-center absolute bottom-[-10vh] px-4">
            ...
            <img 
              ...
              className="-mt-12 w-48 cursor-pointer hover:scale-105 transition-transform"
            />
          </div>
        </div>
      </section>
