          ...
          */}
          <div className="relative mx-auto h-[100svh] w-full translate-y-0 min-[900px]:h-full min-[900px]:w-auto min-[900px]:flex min-[900px]:flex-row-reverse min-[900px]:items-start min-[900px]:gap-8">
            <img
              ...
              className="block w-full h-full max-w-none object-cover object-center -translate-y-16 min-[900px]:translate-y-0 min-[900px]:object-contain min-[900px]:h-[85vh] min-[900px]:w-auto min-[900px]:mt-20 transition-transform"
              loading="eager"
              fetchPriority="high"
            />
