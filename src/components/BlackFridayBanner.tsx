...
const BlackFridayBanner = () => {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50 bg-gradient-to-r from-red-900 via-red-800 to-red-900 text-white shadow-lg border-b border-red-500/20">
      <div className="max-w-7xl mx-auto relative py-1.5 px-4 sm:px-6">
        ...
        <button
          ...
          className="absolute right-2 sm:right-4 top-1/2 -translate-y-1/2 hover:bg-white/20 rounded-full p-0.5 transition-all duration-200 hover:scale-110"
