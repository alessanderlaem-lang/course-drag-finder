...
const SaleCard = ({ price }: { price: string }) => (
  <div className="flex-shrink-0 flex items-center gap-5 bg-[#111111] border border-white/10 rounded-2xl pl-4 pr-7 py-4 mx-2 shadow-lg shadow-black/30 min-w-[420px]">
