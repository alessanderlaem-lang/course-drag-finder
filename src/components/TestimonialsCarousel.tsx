...
const TestimonialsCarousel = () => {
  return (
    <section className="w-full mt-8 md:-mt-8 pb-6 md:pb-8 bg-background relative z-30">
      ...
      <div className="overflow-hidden relative w-full">
        ...
        <div className="flex gap-4 animate-scroll-left w-max">
          {[...feedbacks, ...feedbacks, ...feedbacks, ...feedbacks].map((img, idx) => (
            <img
              key={idx}
              src={img}
              alt={`Feedback de membro ${(idx % 6) + 1}`}
