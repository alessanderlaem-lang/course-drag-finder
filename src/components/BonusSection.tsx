        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {bonuses.map((bonus, index) => {
            ...
            return (
              ...
              >
                <div 
                  className="group relative h-full flex flex-col items-center justify-start bg-background border border-white/30 pt-0 px-6 pb-24 rounded-xl overflow-hidden hover:border-red-500/30 transition-all duration-300 min-h-[220px] w-full max-w-lg mx-auto"
                >
                  <img 
                    src={bonusMetodos} 
                    alt="Bônus Métodos" 
                    className="w-full h-auto object-contain -mt-4 translate-y-4"
                  />
                  <div className="w-full text-left -ml-6 mt-6 translate-y-4">
                    ...
                    <p className="text-foreground font-bold text-3xl md:text-4xl mt-2 whitespace-nowrap">Afiliação a comunidade</p>
                    <p className="text-muted-foreground font-light text-base mt-3 whitespace-nowrap">Seja afiliado da maior comunidade de todas, com uma estrutura</p>
                    <p className="text-muted-foreground font-light text-base whitespace-nowrap">completa, suporte e direcionamento para começar do jeito certo.</p>
                    <p className="text-foreground font-light text-sm mt-3">De <span className="line-through">R$ 497,00</span></p>
                    <img src={nessaOfertaGratis} alt="Nessa oferta: Grátis" className="h-20 -mt-2" />
                  </div>
                </div>
              </motion.div>
            );
