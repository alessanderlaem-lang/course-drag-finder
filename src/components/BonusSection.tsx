    ...
    <section className="w-full pt-[6rem] md:pt-8 pb-6 md:pb-8 px-4 md:px-6 bg-background relative z-50">
      <div className="max-w-7xl mx-auto relative z-50">
        ...
        <div className="flex mb-8 justify-center">
          ...
          >
            <div 
              className="group relative h-full flex flex-col md:flex-row items-center md:items-center justify-start bg-background border border-white/30 p-4 pb-2 md:p-6 rounded-xl overflow-hidden hover:border-red-500/30 transition-all duration-300 w-full gap-2 md:gap-8"
            >
              <img 
                src={bonusMetodos} 
                alt="Bônus Métodos" 
