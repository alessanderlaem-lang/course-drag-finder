          ...
          >
            ...
            >
              ...
              <div className="flex flex-col text-left ml-32">
                ...
                <p className="text-foreground font-light text-3xl mt-6 translate-y-2">De <span className="line-through">R$ 497,00</span></p>
                <img src={nessaOfertaGratis} alt="Nessa oferta: Grátis" className="h-[6rem] -mt-2 translate-y-2 w-fit" />
              </div>
            </div>
          </motion.div>
        </div>
