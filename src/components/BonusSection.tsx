          ...
          >
            ...
            >
              <img 
                ...
                className="w-[340px] h-auto object-contain flex-shrink-0 md:translate-x-24 md:translate-y-2 md:scale-125 origin-center"
              />
              <div className="flex flex-col text-left ml-64 md:-translate-x-16">
          ...
          >
            ...
            >
              <img 
                ...
                className="w-[320px] h-auto object-contain flex-shrink-0 md:translate-x-24 md:scale-115 origin-center"
              />
              <div className="flex flex-col text-left ml-[17rem] md:-translate-x-14">
