          ...
          >
            ...
            >
              ...
              <div className="flex flex-col text-left ml-32">
                ...
                <p className="text-muted-foreground font-light text-[16px] mt-2 translate-y-6">Seja afiliado da maior comunidade de todas,<br/>com uma estrutura completa,<br/>suporte e direcionamento para começar do jeito certo.</p>
