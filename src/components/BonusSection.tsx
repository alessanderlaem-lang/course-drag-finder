        ...
        <div className="flex mb-8 justify-center">
          ...
          >
            ...
            >
              ...
              />
              <div className="flex flex-col text-left w-full pt-4 md:pt-0 md:ml-64 md:-translate-x-16">
        ...
        <div className="flex mb-8 justify-center">
          ...
          >
            ...
            >
              ...
              />
              <div className="flex flex-col text-left w-full pt-4 md:pt-0 md:ml-[18.5rem] md:-translate-x-11">
        ...
        <div className="flex mb-8 justify-center">
          ...
          >
            ...
            >
              ...
              />
              <div className="flex flex-col text-left w-full pt-4 md:pt-0 md:ml-[17rem] md:-translate-x-14">
