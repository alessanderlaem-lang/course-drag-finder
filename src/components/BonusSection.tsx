          ...
          >
            ...
            >
              ...
              <div className="flex flex-col text-left ml-32">
                ...
                <p className="text-muted-foreground font-light text-[16px] mt-2 translate-y-4">Seja afiliado da maior comunidade de todas,<br/>com uma estrutura completa,<br/>suporte e direcionamento para começar do jeito certo.</p>
                <p className="text-foreground font-light text-3xl mt-6 translate-y-12">De <span className="line-through">R$ 497,00</span></p>
                <img src={nessaOfertaGratis} alt="Nessa oferta: Grátis" className="h-[6rem] -mt-2 translate-y-12 w-fit" />
              </div>
            </div>
          </motion.div>
        </div>
