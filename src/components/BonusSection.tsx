        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {bonuses.map((bonus, index) => {
            ...
            return (
              ...
              >
                <div 
                  className="group relative h-full flex flex-col items-center justify-start bg-background border border-white/30 pt-0 px-6 pb-16 rounded-xl overflow-hidden hover:border-red-500/30 transition-all duration-300 min-h-[220px] w-full max-w-lg mx-auto"
                >
                  <img 
                    src={bonusMetodos} 
                    alt="Bônus Métodos" 
