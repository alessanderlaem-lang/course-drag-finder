...
const CommunityShowcase = () => {
  ...
  return (
    <section className="py-12 sm:py-16 lg:py-20 px-4 bg-black">
      {/* Container Card Principal - Similar ao Ratoflix */}
      <div className="max-w-7xl mx-auto">
        <div className="bg-gradient-to-b from-gray-900/80 to-gray-900/40 border border-gray-800/50 rounded-3xl p-6 sm:p-8 lg:p-12 backdrop-blur-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-8 sm:mb-12">
            {pillars.map((pillar, index) => {
              ...
              return (
                <Card
                  key={index}
                  className="bg-gray-800/50 border-gray-700/50 hover:border-red-500/50 transition-all duration-300 cursor-pointer group"
                  ...
                  <CardContent className="p-4 sm:p-6">
                    ...
                    <div className="flex items-start justify-between mb-3 sm:mb-4">
                      <div className="flex items-center gap-2 sm:gap-3">
                        <div className="p-2 sm:p-3 bg-red-500/10 rounded-lg group-hover:bg-red-500/20 transition-colors flex-shrink-0">
                          <Icon className="w-5 h-5 sm:w-6 sm:h-6 text-red-500" />
                        </div>
                        <h3 className="text-base sm:text-lg font-bold text-white group-hover:text-red-500 transition-colors">
                          {pillar.title}
                        </h3>
                      </div>
                      {isExpanded ? (
                    ...
                    {isExpanded && (
                      <div className="mt-3 sm:mt-4 pt-3 sm:pt-4 border-t border-gray-700 animate-in slide-in-from-top-2 duration-300">
                        ...
                        <Badge variant="outline" className="bg-red-500/10 text-red-500 border-red-500/30 text-xs sm:text-sm">
                          {pillar.highlight}
                        </Badge>
                      </div>
                    )}
          ...
          {/* Rateio Highlight - Texto atualizado sem PLRs e ferramentas premium */}
          <div className="bg-gradient-to-r from-red-500/10 via-red-500/5 to-red-500/10 border border-red-500/20 rounded-2xl p-6 sm:p-8 mb-8 sm:mb-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            <div className="flex items-center gap-3 sm:gap-4 p-4 sm:p-6 bg-gray-800/50 border border-gray-700/50 rounded-xl">
              <div className="p-2 sm:p-3 bg-red-500/10 rounded-lg flex-shrink-0">
                <Zap className="w-5 h-5 sm:w-6 sm:h-6 text-red-500" />
              </div>
              <div>
                <h4 className="font-bold text-white text-sm sm:text-base">Atualizações Semanais</h4>
                <p className="text-xs sm:text-sm text-gray-400">Novos conteúdos toda semana</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 sm:gap-4 p-4 sm:p-6 bg-gray-800/50 border border-gray-700/50 rounded-xl">
              ...
              <div>
                <h4 className="font-bold text-white text-sm sm:text-base">Acesso Vitalício</h4>
                <p className="text-xs sm:text-sm text-gray-400">Pague uma vez, acesse para sempre</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 sm:gap-4 p-4 sm:p-6 bg-gray-800/50 border border-gray-700/50 rounded-xl">
              ...
              <div>
                <h4 className="font-bold text-white text-sm sm:text-base">Comunidade no Discord</h4>
                <p className="text-xs sm:text-sm text-gray-400">+7.000 membros ativos</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 sm:gap-4 p-4 sm:p-6 bg-gray-800/50 border border-gray-700/50 rounded-xl">
              ...
              <div>
                <h4 className="font-bold text-white text-sm sm:text-base">Acesso via Telegram</h4>
                <p className="text-xs sm:text-sm text-gray-400">Conteúdos exclusivos</p>
              </div>
            </div>
          </div>
