...
const CommunityShowcase = () => {
  ...
  return (
    <section 
      ref={sectionRef}
      className="relative py-16 sm:py-20 lg:py-24 px-4 bg-black"
    >
      ...
      <div className="relative max-w-7xl mx-auto">
        <div className={`relative bg-[#0a0a0a] border-2 border-gray-800 rounded-3xl p-8 sm:p-10 lg:p-14 pt-12 sm:pt-14 lg:pt-16 transition-all duration-1000 shadow-2xl ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
