        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="bg-black border rounded-3xl p-4 px-3 md:p-12" style={{ borderColor: '#808080' }}>
            ...
            <div className="text-center mb-8">
              ...
              <div className="mb-4 flex items-baseline justify-center -mt-4 md:-mt-8">
            ...
            <div className="flex justify-center items-center mt-8">
              <img src={paymentMethods} alt="MasterCard, VISA, Boleto, PayPal" className="h-10 md:h-12 opacity-70" loading="lazy" decoding="async" />
            </div>
          </div>
        </div>
      </div>
