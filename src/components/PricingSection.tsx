          ...
          <div className="bg-black border rounded-3xl p-4 px-3 md:p-12" style={{ borderColor: '#808080' }}>
            ...
            <div className="space-y-4 mb-12">
              {benefits.map((benefit, index) => (
                ...
                >
                  <Check className="w-5 h-5 text-red-600 flex-shrink-0 mt-0.5" strokeWidth={3.5} />
            ...
            <div className="text-center mb-8">
              ...
              <div className="mb-4 flex items-baseline justify-center">
                <span className="text-3xl md:text-4xl font-semibold relative -top-7 left-2" style={{ background: "linear-gradient(90deg, #FF0000 0%, #A70505 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text" }}>R$ </span>
                <span
